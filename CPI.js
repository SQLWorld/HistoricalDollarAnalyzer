const cpiData = [
 ...
 fn_calculateCpi = function(){
   ...
   let cpiYearIndex = cpiData.findIndex(item => item[0] == cpiYear);
    ...
    let displayResultElement = document.getElementById('displayResult');
    displayResultElement.innerText = `$${formattedDollarToCheck} in ${cpiYear} is worth about $${formattedResultToCheck} in today's dollars (2024) when adjusted for inflation`
